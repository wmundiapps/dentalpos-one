  ...
  return (
    ...
    >
      <Toolbar sx={{ gap: { xs: 1, md: 2 }, minHeight: 72 }}>
        ...
        <Box sx={{ width: 44, height: 44, borderRadius: "50%", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, #0EA5E9, #6366F1)", boxShadow: "0 2px 8px rgba(15,23,42,.18)" }}>
        ...
        <Tooltip title={clinicLogo ? "Logo da instituição" : "Espaço para a logo da sua instituição"}>
          {clinicLogo ? (
            ...
            <Box sx={{ height: 40, px: 1.25, display: { xs: "none", sm: "flex" }, alignItems: "center", gap: 0.75, border: "1px dashed", borderColor: "divider", borderRadius: 2, color: "text.secondary" }}>
              ...
              <Typography variant="caption" sx={{ fontWeight: 700, whiteSpace: "nowrap" }}>{"Sua instituição"}</Typography>
            </Box>
          )}
        </Tooltip>
