...
export default function App() {
  ...
  useEffect(() => {
    if (appPath !== "/redefinir-senha") void validateSession();
  }, [appPath]);
      ...
      >
        <Paper variant="outlined" sx={{ p: 4, borderRadius: 4, width: "min(620px,100%)" }}>
          <Alert severity="warning" sx={{ mb: 2 }}>
            O período de teste gratuito foi encerrado.
          </Alert>
          ...
          <Typography color="text.secondary" sx={{ mt: 1, mb: 1 }}>
            ...
            Programas, alunos e histórico não são apagados automaticamente pelo vencimento do teste.
          </Typography>
          <Typography color="text.secondary" sx={{ mb: 3 }}>
            Para reativar o acesso e continuar utilizando o EduMaster Pro, solicite uma proposta comercial.
          </Typography>
    ...
    return (
      <Box sx={{ minHeight: "100vh", display: "grid", placeItems: "center", p: 2 }}>
        <Paper variant="outlined" sx={{ p: 4, borderRadius: 4, width: "min(520px,100%)" }}>
          <Alert severity="warning" sx={{ mb: 2 }}>A API do EduMaster Pro não respondeu. Nenhum dado foi alterado.</Alert>
