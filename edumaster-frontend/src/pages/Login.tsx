    ...
    >
      ...
      >
        ...
        <Typography color="text.secondary" sx={{ mb: 3 }}>
          Acesso seguro e individualizado da sua instituição.
        </Typography>
        ...
        <TextField
          fullWidth
          label="ID da instituição (opcional)"
          value={clinicId}
          onChange={(event) => setClinicId(event.target.value)}
          helperText="Só é necessário quando o mesmo e-mail pertence a mais de uma instituição."
          sx={{ mb: 2 }}
        />
        <TextField
          fullWidth
      ...
      <Dialog open={resetOpen} onClose={resetBusy ? undefined : () => setResetOpen(false)} fullWidth maxWidth="xs">
        ...
        <DialogContent sx={{ pt: "12px!important" }}>
          ...
          <TextField
            ...
            helperText="Informe apenas quando o mesmo e-mail pertence a mais de uma instituição."
          />
        </DialogContent>
        <DialogActions>
