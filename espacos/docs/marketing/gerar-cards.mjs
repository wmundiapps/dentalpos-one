...
const host = [
  ...
  (n,t)=>`<div class="c">${blobs}${top(n,t)}<div class="body"><h1>O dinheiro cai <em>direto</em> na sua conta.</h1><p class="sub">Pix ou cartão pelo Mercado Pago. Sem mensalidade: 5% por reserva + tarifa do Mercado Pago.</p><div class="money"><small>Exemplo: 12 h/semana × R$ 60/h</small><strong>R$ 2.736,00</strong><em>em 4 semanas, após a taxa de 5% e antes da tarifa do Mercado Pago · simulação</em></div></div>${foot(false,H)}</div>`,
