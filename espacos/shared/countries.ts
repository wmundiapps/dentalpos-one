...
export const COUNTRIES: CountryConfig[] = [
  ...
  },
  {
    ...
    taxName: 'IVA', taxRate: 0.19, withdrawalDays: 7 /* 5 dias úteis (Ley 1480/2011, art. 47) ≈ 7 corridos */, minAge: 18,
  ...
  },
  {
    ...
    taxName: 'IVA', taxRate: 0.15, withdrawalDays: 3 /* LODC, art. 45 */, minAge: 18,
  ...
  },
  {
    ...
    paymentMethods: ['card', 'mercado_pago', 'bank_transfer'],
    taxName: 'IVA', taxRate: 0.22, withdrawalDays: 7 /* 5 dias úteis (Ley 17.250, art. 16) ≈ 7 corridos */, minAge: 18,
  ...
  },
  {
    ...
    paymentMethods: ['card', 'bank_transfer', 'paypal'],
    taxName: 'IVA', taxRate: 0.13, withdrawalDays: 11 /* 8 dias úteis ≈ 11 corridos */, minAge: 18,
  ...
  // ───────────── América do Norte ─────────────
  {
    ...
    taxName: 'IVA', taxRate: 0.16, withdrawalDays: 7 /* 5 dias úteis (LFPC, art. 56) ≈ 7 corridos */, minAge: 18,
  ...
  },
  {
    ...
    dataProtectionLaw: 'State privacy laws (e.g., CCPA/CPRA in California), plus HIPAA for healthcare providers (covered entities) — not the platform itself',
  ...
  },
  {
    ...
    licenseBodies: { dental: 'Approbation (Landesbehörde) + Landeszahnärztekammer', medical: 'Approbation (Landesbehörde) + Landesärztekammer', psychology: 'Psychotherapeutenkammer', law: 'Rechtsanwaltskammer', physio: 'Berufserlaubnis (Gesundheitsamt)', default: 'Zuständige Kammer' },
  ...
  },
  {
    ...
    licenseBodies: { dental: 'National Dental Commission (ex-Dental Council of India) / State Dental Council', medical: 'National Medical Commission / State Medical Council', psychology: 'Rehabilitation Council of India (clinical psychologists)', law: 'Bar Council of India / State Bar Council', default: 'Competent council' },
