...
export function enqueueAppointmentReminders(input:{appointmentId:number;patientName:string;phone?:string;dateISO:string;time:string;channel:"WhatsApp"|"SMS"}){
