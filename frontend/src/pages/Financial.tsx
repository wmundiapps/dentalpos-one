...
export default function Financial(){
 ...
 const add=async()=>{
   if(!form.description.trim()||!form.personName.trim()||!form.value||!form.dueDate)return;
