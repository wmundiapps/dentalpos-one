...
// Variáveis: {{nome}}, {{primeiro_nome}}, {{minha_empresa}}, {{data}}, {{hora}}, {{valor}}, {{link}}.
...
export const TEMPLATE_LIBRARY: LibraryTemplate[] = [
  ...
  { key: 'vendas-followup', segment: 'Vendas & Comercial', name: 'Follow-up de lead', body: 'Olá, {{primeiro_nome}}! Aqui é da {{minha_empresa}}. Vi que você se interessou pelos nossos serviços. Posso te ajudar com alguma dúvida?' },
  ...
  { key: 'geral-boas-vindas', segment: 'Geral', name: 'Boas-vindas', body: 'Olá, {{primeiro_nome}}! Seja bem-vindo(a) à {{minha_empresa}}. Estamos por aqui para o que precisar.' },
  { key: 'geral-pesquisa', segment: 'Geral', name: 'Pesquisa de satisfação', body: 'Olá, {{primeiro_nome}}! De 0 a 10, quanto você recomendaria a {{minha_empresa}} para um amigo? Sua opinião nos ajuda a melhorar.' },
]
